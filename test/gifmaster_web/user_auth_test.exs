defmodule GifmasterWeb.UserAuthTest do
  use GifmasterWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Gifmaster.Account
  alias GifmasterWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GifmasterWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GifmasterWeb.Endpoint.subscribe(live_socket_id)

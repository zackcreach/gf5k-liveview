...
config :gifmaster, GifmasterWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: GifmasterWeb.ErrorHTML, json: GifmasterWeb.ErrorJSON],
    layout: false
  ],
...
config :gifmaster, Gifmaster.Mailer, adapter: Swoosh.Adapters.Local

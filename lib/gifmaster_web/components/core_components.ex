defmodule GifmasterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GifmasterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GifmasterWeb.Gettext, "errors", msg, opts)
    end
  end
